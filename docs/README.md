# DevTrail Documentation

This folder contains the main project documentation for DevTrail.

- `README.md` - full project overview, setup, and API reference
- `DEPLOYMENT.md` - deployment instructions and production readiness
...
- Use `npm audit` to check dependencies before production.
- Use `docs/DEPLOYMENT.md` for deployment steps.
